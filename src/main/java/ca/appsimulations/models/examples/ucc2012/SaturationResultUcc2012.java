...
@Slf4j
public class SaturationResultUcc2012  {
    ...
    private static Cloud buildCloud(App app) {
        ContainerType medium = new ContainerType("medium",
                                                5,
                                                2,
                                                14);
        ...
        Cloud cloud = CloudBuilder.builder()
                .name("cloud1")
                .containerTypes(asList(SM, medium, large))
        ...
        cloud.instantiateContainer("TaskA", SM, 6);
        cloud.instantiateContainer("TaskB", SM, 5);
        cloud.instantiateContainer("TaskC", medium, 2);
